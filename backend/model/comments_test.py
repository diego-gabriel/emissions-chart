...
class TestComments:
    ...
    def test_create_comments(self) -> None:
        comment = Comments.create("foo", "bob", None)
    ...
    def test_finds_all_comments(self) -> None:
        c1 = Comments.create("comment 1", "alice", None)
        c2 = Comments.create("comment 2", "bob", None)
        c3 = Comments.create("comment 3", "alice", c2.id)
    ...
    def test_finds_a_comment(self) -> None:
        Comments.create("comment 1", "alice", None)
        c2 = Comments.create("comment 2", "bob", None)
        Comments.create("comment 3", "alice", None)
